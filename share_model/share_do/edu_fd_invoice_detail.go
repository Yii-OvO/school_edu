...
// EduFdInvoiceDetail is the golang structure of table edu_fd_invoice_detail for DAO operations like Where/Data.
type EduFdInvoiceDetail struct {
	g.Meta        `orm:"table:edu_fd_invoice_detail, do:true"`
	Id            interface{} // ID
