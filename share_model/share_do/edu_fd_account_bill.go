...
// EduFdAccountBill is the golang structure of table edu_fd_account_bill for DAO operations like Where/Data.
type EduFdAccountBill struct {
	g.Meta        `orm:"table:edu_fd_account_bill, do:true"`
	Id            interface{} // ID
