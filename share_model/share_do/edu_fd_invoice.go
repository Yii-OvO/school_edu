...
// EduFdInvoice is the golang structure of table edu_fd_invoice for DAO operations like Where/Data.
type EduFdInvoice struct {
	g.Meta        `orm:"table:edu_fd_invoice, do:true"`
	Id            interface{} //
