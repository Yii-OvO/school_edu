...
// EduFdAccount is the golang structure of table edu_fd_account for DAO operations like Where/Data.
type EduFdAccount struct {
	g.Meta             `orm:"table:edu_fd_account, do:true"`
	Id                 interface{} // ID
	Name               interface{} // 账户名称
