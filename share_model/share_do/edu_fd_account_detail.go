...
// EduFdAccountDetail is the golang structure of table edu_fd_account_detail for DAO operations like Where/Data.
type EduFdAccountDetail struct {
	g.Meta            `orm:"table:edu_fd_account_detail, do:true"`
