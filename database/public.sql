...
START 1
CACHE 1;
ALTER SEQUENCE "public"."sys_area_id_seq" OWNER TO "kuaimk";

-- ----------------------------
-- Table structure for edu_fd_account
-- ----------------------------
DROP TABLE IF EXISTS "public"."edu_fd_account";
CREATE TABLE "public"."edu_fd_account" (
  "id" int8 NOT NULL,
...
;
ALTER TABLE "public"."edu_fd_account" OWNER TO "kuaimk";
COMMENT ON COLUMN "public"."edu_fd_account"."id" IS 'ID';
COMMENT ON COLUMN "public"."edu_fd_account"."name" IS '账户名称';
COMMENT ON COLUMN "public"."edu_fd_account"."union_license_id" IS '关联资质ID，大于0时必须保值与 union_user_id 关联得上';
COMMENT ON COLUMN "public"."edu_fd_account"."union_user_id" IS '关联用户ID';
COMMENT ON COLUMN "public"."edu_fd_account"."currency_code" IS '货币代码';
COMMENT ON COLUMN "public"."edu_fd_account"."is_enabled" IS '是否启用：1启用，0禁用';
COMMENT ON COLUMN "public"."edu_fd_account"."limit_state" IS '限制状态：0不限制，1限制支出、2限制收入';
COMMENT ON COLUMN "public"."edu_fd_account"."precision_of_balance" IS '货币单位精度：1:元，10:角，100:分，1000:厘，10000:毫，……';
COMMENT ON COLUMN "public"."edu_fd_account"."balance" IS '当前余额，必须要与账单最后一笔交易余额对应得上';
COMMENT ON COLUMN "public"."edu_fd_account"."version" IS '乐观锁所需数据版本字段';
COMMENT ON COLUMN "public"."edu_fd_account"."scene_type" IS '场景类型：0不限、1充电佣金收入';
COMMENT ON COLUMN "public"."edu_fd_account"."account_type" IS '账户类型：1系统账户、2银行卡、3支付宝、4微信、5云闪付、6翼支付';
COMMENT ON COLUMN "public"."edu_fd_account"."account_number" IS '账户编号，例如银行卡号、支付宝账号、微信账号等对应账户类型的编号';
COMMENT ON COLUMN "public"."edu_fd_account"."union_main_id" IS '关联主体ID，与union_license_id 中的union_main_id 一致';

-- ----------------------------
-- Records of edu_fd_account
-- ----------------------------
BEGIN;
INSERT INTO "public"."edu_fd_account" ("id", "name", "union_license_id", "union_user_id", "currency_code", "is_enabled", "limit_state", "precision_of_balance", "balance", "version", "created_at", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "scene_type", "account_type", "account_number", "union_main_id") VALUES (6730105454067781, '0523协会创建', 0, 6730105419530309, 'CNY', 1, 0, 100, 0, 0, '2023-05-23 16:14:21.49237', 5302581852373061, '2023-05-23 16:14:21.49237', NULL, NULL, NULL, 0, 1, '', 6730105417498693);
INSERT INTO "public"."edu_fd_account" ("id", "name", "union_license_id", "union_user_id", "currency_code", "is_enabled", "limit_state", "precision_of_balance", "balance", "version", "created_at", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "scene_type", "account_type", "account_number", "union_main_id") VALUES (6730154305126469, '0523学校创建', 0, 6730154277208133, 'CNY', 1, 0, 100, 0, 0, '2023-05-23 16:26:46.900246', 6730105419530309, '2023-05-23 16:26:46.900246', NULL, NULL, NULL, 0, 1, '', 6730154276552773);
INSERT INTO "public"."edu_fd_account" ("id", "name", "union_license_id", "union_user_id", "currency_code", "is_enabled", "limit_state", "precision_of_balance", "balance", "version", "created_at", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "scene_type", "account_type", "account_number", "union_main_id") VALUES (6730158731165765, '0523学校创建02', 0, 6730158708752453, 'CNY', 1, 0, 100, 0, 0, '2023-05-23 16:27:54.437174', 6730105419530309, '2023-05-23 16:27:54.437174', NULL, NULL, NULL, 0, 1, '', 6730158708162629);
INSERT INTO "public"."edu_fd_account" ("id", "name", "union_license_id", "union_user_id", "currency_code", "is_enabled", "limit_state", "precision_of_balance", "balance", "version", "created_at", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "scene_type", "account_type", "account_number", "union_main_id") VALUES (6734417490083909, '0524学校创建03', 0, 6734417466294341, 'CNY', 1, 0, 100, 0, 0, '2023-05-24 10:30:57.94071', 6730105419530309, '2023-05-24 10:30:57.94071', NULL, NULL, NULL, 0, 1, '', 6734417465507909);
INSERT INTO "public"."edu_fd_account" ("id", "name", "union_license_id", "union_user_id", "currency_code", "is_enabled", "limit_state", "precision_of_balance", "balance", "version", "created_at", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "scene_type", "account_type", "account_number", "union_main_id") VALUES (6734638118797381, '0524协会01', 0, 6734637130252357, 'CNY', 1, 0, 100, 0, 0, '2023-05-24 11:27:04.468036', 5302581852373061, '2023-05-24 11:27:04.468036', NULL, NULL, NULL, 0, 1, '', 6734637127893061);
INSERT INTO "public"."edu_fd_account" ("id", "name", "union_license_id", "union_user_id", "currency_code", "is_enabled", "limit_state", "precision_of_balance", "balance", "version", "created_at", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "scene_type", "account_type", "account_number", "union_main_id") VALUES (6734648363515973, '0524学校01', 0, 6734647962435653, 'CNY', 1, 0, 100, 0, 0, '2023-05-24 11:29:40.79', 6734637130252357, '2023-05-24 11:29:40.79', NULL, NULL, NULL, 0, 1, '', 6734647961714757);
COMMIT;

-- ----------------------------
-- Table structure for edu_fd_account_bill
-- ----------------------------
DROP TABLE IF EXISTS "public"."edu_fd_account_bill";
CREATE TABLE "public"."edu_fd_account_bill" (
  "id" int8 NOT NULL,
...
;
ALTER TABLE "public"."edu_fd_account_bill" OWNER TO "kuaimk";
COMMENT ON COLUMN "public"."edu_fd_account_bill"."id" IS 'ID';
COMMENT ON COLUMN "public"."edu_fd_account_bill"."from_user_id" IS '交易发起方UserID，如果是系统则固定为-1';
COMMENT ON COLUMN "public"."edu_fd_account_bill"."to_user_id" IS '交易对象UserID';
COMMENT ON COLUMN "public"."edu_fd_account_bill"."fd_account_id" IS '财务账户ID';
COMMENT ON COLUMN "public"."edu_fd_account_bill"."before_balance" IS '交易前账户余额';
COMMENT ON COLUMN "public"."edu_fd_account_bill"."amount" IS '交易金额';
COMMENT ON COLUMN "public"."edu_fd_account_bill"."after_balance" IS '交易后账户余额';
COMMENT ON COLUMN "public"."edu_fd_account_bill"."union_order_id" IS '关联业务订单ID';
COMMENT ON COLUMN "public"."edu_fd_account_bill"."in_out_type" IS '收支类型：1收入，2支出';
COMMENT ON COLUMN "public"."edu_fd_account_bill"."trade_type" IS '交易类型，1转账、2消费、4退款、8佣金、16保证金、32诚意金、64手续费/服务费、128提现、256充值、512营收，8192其它';
COMMENT ON COLUMN "public"."edu_fd_account_bill"."trade_at" IS '交易时间';
COMMENT ON COLUMN "public"."edu_fd_account_bill"."remark" IS '备注信息';
COMMENT ON COLUMN "public"."edu_fd_account_bill"."trade_state" IS '交易状态：1待支付、2支付中、4已支付、8取消支付、16交易完成、32退款中、64已退款、128支付超时、256已关闭';

-- ----------------------------
-- Records of edu_fd_account_bill
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for edu_fd_account_detail
-- ----------------------------
DROP TABLE IF EXISTS "public"."edu_fd_account_detail";
CREATE TABLE "public"."edu_fd_account_detail" (
  "id" int8 NOT NULL,
  "today_account_sum" int4,
  "today_updated_at" date,
  "week_account_sum" int4,
  "week_updated_at" date,
  "month_account_sum" int4,
  "month_updated_at" date,
  "quarter_account_sum" int4,
  "quarter_updated_at" date,
  "year_account_sum" int8,
...
;
ALTER TABLE "public"."edu_fd_account_detail" OWNER TO "kuaimk";
COMMENT ON COLUMN "public"."edu_fd_account_detail"."id" IS '和财务账号 id保持一致';
COMMENT ON COLUMN "public"."edu_fd_account_detail"."today_account_sum" IS '今日金额';
COMMENT ON COLUMN "public"."edu_fd_account_detail"."today_updated_at" IS '今日金额更新时间';
COMMENT ON COLUMN "public"."edu_fd_account_detail"."week_account_sum" IS '本周金额';
COMMENT ON COLUMN "public"."edu_fd_account_detail"."week_updated_at" IS '本周金额更新时间';
COMMENT ON COLUMN "public"."edu_fd_account_detail"."month_account_sum" IS '本月金额';
COMMENT ON COLUMN "public"."edu_fd_account_detail"."month_updated_at" IS '本月金额更新时间';
COMMENT ON COLUMN "public"."edu_fd_account_detail"."quarter_account_sum" IS '本季度金额统计';
COMMENT ON COLUMN "public"."edu_fd_account_detail"."quarter_updated_at" IS '本季度金额更新时间';
COMMENT ON COLUMN "public"."edu_fd_account_detail"."year_account_sum" IS '本年度金额统计';
COMMENT ON COLUMN "public"."edu_fd_account_detail"."year_updated_at" IS '本年度金额更新时间';
COMMENT ON COLUMN "public"."edu_fd_account_detail"."union_main_id" IS '关联主体id';
COMMENT ON COLUMN "public"."edu_fd_account_detail"."sys_user_id" IS '关联用户id';
COMMENT ON COLUMN "public"."edu_fd_account_detail"."version" IS '乐观锁所需数据版本字段';
COMMENT ON COLUMN "public"."edu_fd_account_detail"."scene_type" IS '场景类型：0不限';

-- ----------------------------
-- Records of edu_fd_account_detail
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for edu_fd_bank_card
-- ----------------------------
DROP TABLE IF EXISTS "public"."edu_fd_bank_card";
CREATE TABLE "public"."edu_fd_bank_card" (
  "id" int8 NOT NULL,
...
;
ALTER TABLE "public"."edu_fd_bank_card" OWNER TO "kuaimk";
COMMENT ON COLUMN "public"."edu_fd_bank_card"."id" IS 'ID';
COMMENT ON COLUMN "public"."edu_fd_bank_card"."bank_name" IS '银行名称';
COMMENT ON COLUMN "public"."edu_fd_bank_card"."card_type" IS '银行卡类型：1借记卡，2储蓄卡';
COMMENT ON COLUMN "public"."edu_fd_bank_card"."card_number" IS '银行卡号';
COMMENT ON COLUMN "public"."edu_fd_bank_card"."expired_at" IS '有效期';
COMMENT ON COLUMN "public"."edu_fd_bank_card"."holder_name" IS '银行卡开户名';
COMMENT ON COLUMN "public"."edu_fd_bank_card"."bank_of_account" IS '开户行';
COMMENT ON COLUMN "public"."edu_fd_bank_card"."state" IS '状态：0禁用，1正常';
COMMENT ON COLUMN "public"."edu_fd_bank_card"."remark" IS '备注信息';
COMMENT ON COLUMN "public"."edu_fd_bank_card"."user_id" IS '用户id，表示属于谁';

-- ----------------------------
-- Records of edu_fd_bank_card
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for edu_fd_currency
-- ----------------------------
DROP TABLE IF EXISTS "public"."edu_fd_currency";
CREATE TABLE "public"."edu_fd_currency" (
...
;
ALTER TABLE "public"."edu_fd_currency" OWNER TO "kuaimk";
COMMENT ON COLUMN "public"."edu_fd_currency"."code" IS '国家编码';
COMMENT ON COLUMN "public"."edu_fd_currency"."en_name" IS '国家英文名称';
COMMENT ON COLUMN "public"."edu_fd_currency"."cn_name" IS '国家中文名称';
COMMENT ON COLUMN "public"."edu_fd_currency"."currency_code" IS '货币编码';
COMMENT ON COLUMN "public"."edu_fd_currency"."currency_cn" IS '货币中文名称';
COMMENT ON COLUMN "public"."edu_fd_currency"."currency_en" IS '货币英文名称';
COMMENT ON COLUMN "public"."edu_fd_currency"."symbol" IS '货币符号';
COMMENT ON COLUMN "public"."edu_fd_currency"."symbol_native" IS '货币原生符号';
COMMENT ON COLUMN "public"."edu_fd_currency"."is_legal_tender" IS '是否法定货币：1是，0否';
COMMENT ON COLUMN "public"."edu_fd_currency"."currency_rate" IS '货币汇率，本币为人民币';

-- ----------------------------
-- Records of edu_fd_currency
-- ----------------------------
BEGIN;
INSERT INTO "public"."edu_fd_currency" ("code", "en_name", "cn_name", "currency_code", "currency_cn", "currency_en", "symbol", "symbol_native", "is_legal_tender", "currency_rate") VALUES ('US', 'United States of America (USA)', '美国', 'USD', '美元', 'US Dollar', '$', '$', 1, NULL);
INSERT INTO "public"."edu_fd_currency" ("code", "en_name", "cn_name", "currency_code", "currency_cn", "currency_en", "symbol", "symbol_native", "is_legal_tender", "currency_rate") VALUES ('HK', 'Hong Kong', '香港', 'HKD', '港元', 'Hong Kong Dollar', 'HK$', '$', 1, NULL);
INSERT INTO "public"."edu_fd_currency" ("code", "en_name", "cn_name", "currency_code", "currency_cn", "currency_en", "symbol", "symbol_native", "is_legal_tender", "currency_rate") VALUES ('TW', 'Taiwan', '台湾', 'TWD', '新台币', 'New Taiwan Dollar', 'NT$', '$', 1, NULL);
INSERT INTO "public"."edu_fd_currency" ("code", "en_name", "cn_name", "currency_code", "currency_cn", "currency_en", "symbol", "symbol_native", "is_legal_tender", "currency_rate") VALUES ('JP', 'Japan', '日本', 'JPY', '日元', 'Japanese Yen', 'JP¥', '¥', 1, NULL);
INSERT INTO "public"."edu_fd_currency" ("code", "en_name", "cn_name", "currency_code", "currency_cn", "currency_en", "symbol", "symbol_native", "is_legal_tender", "currency_rate") VALUES ('CN', 'China', '中国', 'CNY', '人民币元', 'Chinese Yuan', '¥', '¥', 1, NULL);
INSERT INTO "public"."edu_fd_currency" ("code", "en_name", "cn_name", "currency_code", "currency_cn", "currency_en", "symbol", "symbol_native", "is_legal_tender", "currency_rate") VALUES ('EU', 'European Union', '欧盟', 'EUR', '欧元', 'Euro', '€', '€', 1, NULL);
INSERT INTO "public"."edu_fd_currency" ("code", "en_name", "cn_name", "currency_code", "currency_cn", "currency_en", "symbol", "symbol_native", "is_legal_tender", "currency_rate") VALUES ('BTC', 'Bitcoin', 'BTC', 'BTC', '比特币', 'BTC', '฿', '฿', 0, NULL);
INSERT INTO "public"."edu_fd_currency" ("code", "en_name", "cn_name", "currency_code", "currency_cn", "currency_en", "symbol", "symbol_native", "is_legal_tender", "currency_rate") VALUES ('USDT', 'TetherUSD', 'USDT', 'USDT', '泰达币', 'USDT', 'USDT$', '$', 0, NULL);
INSERT INTO "public"."edu_fd_currency" ("code", "en_name", "cn_name", "currency_code", "currency_cn", "currency_en", "symbol", "symbol_native", "is_legal_tender", "currency_rate") VALUES ('ETH', 'Ethereum', 'ETH', 'ETH', '以太币', 'ETH', 'ETH$', '$', 0, NULL);
COMMIT;

-- ----------------------------
-- Table structure for edu_fd_invoice
-- ----------------------------
DROP TABLE IF EXISTS "public"."edu_fd_invoice";
CREATE TABLE "public"."edu_fd_invoice" (
  "id" int8 NOT NULL,
  "name" varchar(128) COLLATE "pg_catalog"."default" NOT NULL,
...
;
ALTER TABLE "public"."edu_fd_invoice" OWNER TO "kuaimk";
COMMENT ON COLUMN "public"."edu_fd_invoice"."name" IS '发票抬头名称';
COMMENT ON COLUMN "public"."edu_fd_invoice"."tax_id" IS '纳税识别号';
COMMENT ON COLUMN "public"."edu_fd_invoice"."addr" IS '发票收件地址，限纸质';
COMMENT ON COLUMN "public"."edu_fd_invoice"."email" IS '发票收件邮箱，限电子发票';
COMMENT ON COLUMN "public"."edu_fd_invoice"."user_id" IS '申请人UserID';
COMMENT ON COLUMN "public"."edu_fd_invoice"."audit_user_id" IS '审核人UserID';
COMMENT ON COLUMN "public"."edu_fd_invoice"."audit_reply_msg" IS '审核回复，仅审核不通过时才有值';
COMMENT ON COLUMN "public"."edu_fd_invoice"."audit_at" IS '审核时间';
COMMENT ON COLUMN "public"."edu_fd_invoice"."state" IS '状态：0待审核、1已通过、-1不通过';
COMMENT ON COLUMN "public"."edu_fd_invoice"."union_main_id" IS '主体ID：运营商ID、服务商ID、商户ID、消费者ID';

-- ----------------------------
-- Records of edu_fd_invoice
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for edu_fd_invoice_detail
-- ----------------------------
DROP TABLE IF EXISTS "public"."edu_fd_invoice_detail";
CREATE TABLE "public"."edu_fd_invoice_detail" (
  "id" int8 NOT NULL,
...
;
ALTER TABLE "public"."edu_fd_invoice_detail" OWNER TO "kuaimk";
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."id" IS 'ID';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."tax_number" IS '纳税识别号';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."tax_name" IS '纳税人名称';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."bill_ids" IS '账单ID组';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."amount" IS '开票金额，单位精度：分';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."rate" IS '税率，如3% 则填入3';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."rate_mount" IS '税额，单位精度：分';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."remark" IS '发布内容描述';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."type" IS '发票类型：1电子发票，2纸质发票';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."state" IS '状态：1待审核、2待开票、4开票失败、8已开票、16已撤销';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."audit_user_ids" IS '审核者UserID，多个用逗号隔开';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."make_type" IS '出票类型：1普通发票、2增值税专用发票、3专业发票';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."make_user_id" IS '出票人UserID，如果是系统出票则默认-1';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."make_at" IS '出票时间';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."courier_name" IS '快递名称，限纸质发票';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."courier_number" IS '快递编号，限纸质发票';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."fd_invoice_id" IS '发票抬头ID';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."audit_user_id" IS '审核者UserID';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."audit_reply_msg" IS '审核回复，仅审核不通过时才有值';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."audit_at" IS '审核时间';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."user_id" IS '申请者用户ID';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."union_main_id" IS '主体ID：运营商ID、服务商ID、商户ID、消费者ID';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."email" IS '发票收件邮箱，限电子发票';
COMMENT ON COLUMN "public"."edu_fd_invoice_detail"."belong_to" IS '发票拥有者类型：1个人  2主体';

-- ----------------------------
-- Records of edu_fd_invoice_detail
-- ----------------------------
BEGIN;
COMMIT;
...
-- ----------------------------
DROP TABLE IF EXISTS "public"."edu_school";
...
;
ALTER TABLE "public"."edu_school" OWNER TO "kuaimk";
COMMENT ON COLUMN "public"."edu_school"."id" IS 'ID';
COMMENT ON COLUMN "public"."edu_school"."name" IS '名称';
COMMENT ON COLUMN "public"."edu_school"."contact_name" IS '商务联系人';
COMMENT ON COLUMN "public"."edu_school"."contact_mobile" IS '商务联系电话';
COMMENT ON COLUMN "public"."edu_school"."user_id" IS '管理员ID';
COMMENT ON COLUMN "public"."edu_school"."state" IS '状态：0未启用，1正常';
COMMENT ON COLUMN "public"."edu_school"."remark" IS '备注';
COMMENT ON COLUMN "public"."edu_school"."created_by" IS '创建者';
COMMENT ON COLUMN "public"."edu_school"."created_at" IS '创建时间';
COMMENT ON COLUMN "public"."edu_school"."updated_by" IS '更新者';
COMMENT ON COLUMN "public"."edu_school"."updated_at" IS '更新时间';
COMMENT ON COLUMN "public"."edu_school"."deleted_by" IS '删除者';
COMMENT ON COLUMN "public"."edu_school"."deleted_at" IS '删除时间';
COMMENT ON COLUMN "public"."edu_school"."parent_id" IS '父级ID';
COMMENT ON COLUMN "public"."edu_school"."address" IS '地址';

-- ----------------------------
-- Records of edu_school
-- ----------------------------
BEGIN;
INSERT INTO "public"."edu_school" ("id", "name", "contact_name", "contact_mobile", "user_id", "state", "remark", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "parent_id", "address") VALUES (6730105417498693, '0523协会创建更新', '01测试0523', '18139422575', 6730105419530309, NULL, 'ea', 5302581852373061, '2023-05-23 16:14:21.462761', 5302581852373061, '2023-05-23 16:18:23.342864', NULL, NULL, 0, '山西省上海市富宁县');
INSERT INTO "public"."edu_school" ("id", "name", "contact_name", "contact_mobile", "user_id", "state", "remark", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "parent_id", "address") VALUES (6730158708162629, '0523学校创建02', '学校02管理员0523', '18183197534', 6730158708752453, NULL, 'ex magna sint', 6730105419530309, '2023-05-23 16:27:54.430834', NULL, '2023-05-23 16:27:54.430834', NULL, NULL, 6730105417498693, '广东省深圳龙华区');
INSERT INTO "public"."edu_school" ("id", "name", "contact_name", "contact_mobile", "user_id", "state", "remark", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "parent_id", "address") VALUES (6730154276552773, '0523学校创建01更新', '学校01管理员0523', '18183426417', 6730154277208133, NULL, 'ea4dsaf', 6730105419530309, '2023-05-23 16:26:46.896141', 6730105419530309, '2023-05-23 16:33:53.393106', NULL, NULL, 6730105417498693, '上海市');
INSERT INTO "public"."edu_school" ("id", "name", "contact_name", "contact_mobile", "user_id", "state", "remark", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "parent_id", "address") VALUES (6734417465507909, '0524学校创建03', '学校03管理员0524', '18183197123', 6734417466294341, NULL, 'ex magna sint', 6730105419530309, '2023-05-24 10:30:57.906197', NULL, '2023-05-24 10:30:57.906197', NULL, NULL, 6730105417498693, '广东省深圳龙华区');
INSERT INTO "public"."edu_school" ("id", "name", "contact_name", "contact_mobile", "user_id", "state", "remark", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "parent_id", "address") VALUES (6734637127893061, '0524协会01', '协会管理员01', '19838273548', 6734637130252357, NULL, 'Ut fugiat', 5302581852373061, '2023-05-24 11:26:49.84852', NULL, '2023-05-24 11:26:49.84852', NULL, NULL, 0, '黑龙江省恩施土家族苗族自治州青铜峡市');
INSERT INTO "public"."edu_school" ("id", "name", "contact_name", "contact_mobile", "user_id", "state", "remark", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "parent_id", "address") VALUES (6734647961714757, '0524学校01', '学校01管理员01', '19861312951', 6734647962435653, NULL, 'occaecat officia dolore et id', 6734637130252357, '2023-05-24 11:29:34.999895', NULL, '2023-05-24 11:29:34.999895', NULL, NULL, 6734637127893061, '黑龙江省福州市贵定县');
COMMIT;

-- ----------------------------
-- Table structure for edu_school_class
-- ----------------------------
DROP TABLE IF EXISTS "public"."edu_school_class";
CREATE TABLE "public"."edu_school_class" (
  "id" int8 NOT NULL,
  "name" varchar(128) COLLATE "pg_catalog"."default" NOT NULL,
...
;
ALTER TABLE "public"."edu_school_class" OWNER TO "kuaimk";
COMMENT ON COLUMN "public"."edu_school_class"."id" IS 'ID';
COMMENT ON COLUMN "public"."edu_school_class"."name" IS '班级名称，学校维度下唯一';
COMMENT ON COLUMN "public"."edu_school_class"."owner_employee_id" IS '班主任/班长';
COMMENT ON COLUMN "public"."edu_school_class"."captain_employee_id" IS '班长/组长，仅限当前班级成员中选择';
COMMENT ON COLUMN "public"."edu_school_class"."union_main_id" IS '所属主体单位ID';
COMMENT ON COLUMN "public"."edu_school_class"."parent_id" IS '父级ID';
COMMENT ON COLUMN "public"."edu_school_class"."remark" IS '备注';

-- ----------------------------
-- Records of edu_school_class
-- ----------------------------
BEGIN;
INSERT INTO "public"."edu_school_class" ("id", "name", "owner_employee_id", "captain_employee_id", "union_main_id", "parent_id", "remark", "created_at", "updated_at", "deleted_at") VALUES (6730245735383109, '0523班级再创建', 0, 0, 6730154276552773, 0, '属于学校01', '2023-05-23 16:50:02.016369', '2023-05-23 16:50:02.016369', NULL);
INSERT INTO "public"."edu_school_class" ("id", "name", "owner_employee_id", "captain_employee_id", "union_main_id", "parent_id", "remark", "created_at", "updated_at", "deleted_at") VALUES (6730195048529989, '0523班级创建更新', 0, 0, 6730158708162629, 0, '属于学校02', '2023-05-23 16:37:08.597084', '2023-05-23 16:52:16.111684', NULL);
INSERT INTO "public"."edu_school_class" ("id", "name", "owner_employee_id", "captain_employee_id", "union_main_id", "parent_id", "remark", "created_at", "updated_at", "deleted_at") VALUES (6730239843434565, '0523班级创建', 6730278827655237, 6730662334496837, 6730154276552773, 0, '属于学校01', '2023-05-23 16:48:32.112107', '2023-05-23 18:56:14.669652', NULL);
INSERT INTO "public"."edu_school_class" ("id", "name", "owner_employee_id", "captain_employee_id", "union_main_id", "parent_id", "remark", "created_at", "updated_at", "deleted_at") VALUES (6734846439260229, '0524学校01班级01', 6734669398999109, 6734675772047429, 6734647961714757, 0, '备注更新', '2023-05-24 12:20:03.18619', '2023-05-24 17:13:48.87654', NULL);
COMMIT;

-- ----------------------------
-- Table structure for edu_school_class_member
-- ----------------------------
DROP TABLE IF EXISTS "public"."edu_school_class_member";
CREATE TABLE "public"."edu_school_class_member" (
  "id" int8 NOT NULL,
...
;
ALTER TABLE "public"."edu_school_class_member" OWNER TO "kuaimk";
COMMENT ON COLUMN "public"."edu_school_class_member"."id" IS 'ID';
COMMENT ON COLUMN "public"."edu_school_class_member"."team_id" IS '班级ID';
COMMENT ON COLUMN "public"."edu_school_class_member"."employee_id" IS '成员ID';
COMMENT ON COLUMN "public"."edu_school_class_member"."invite_user_id" IS '邀约人ID';
COMMENT ON COLUMN "public"."edu_school_class_member"."union_main_id" IS '关联主体ID';
COMMENT ON COLUMN "public"."edu_school_class_member"."join_at" IS '加入时间';

-- ----------------------------
-- Records of edu_school_class_member
-- ----------------------------
BEGIN;
INSERT INTO "public"."edu_school_class_member" ("id", "team_id", "employee_id", "invite_user_id", "union_main_id", "join_at") VALUES (6730736102342725, 6730239843434565, 6730662334496837, NULL, 6730154276552773, '2023-05-23 18:54:44.421321');
INSERT INTO "public"."edu_school_class_member" ("id", "team_id", "employee_id", "invite_user_id", "union_main_id", "join_at") VALUES (6730736102473797, 6730239843434565, 6730665474261061, NULL, 6730154276552773, '2023-05-23 18:54:44.42399');
INSERT INTO "public"."edu_school_class_member" ("id", "team_id", "employee_id", "invite_user_id", "union_main_id", "join_at") VALUES (6734916910055493, 6734846439260229, 6734675772047429, NULL, 6734647961714757, '2023-05-24 12:37:58.484814');
INSERT INTO "public"."edu_school_class_member" ("id", "team_id", "employee_id", "invite_user_id", "union_main_id", "join_at") VALUES (6735834175832133, 6734846439260229, 6734693023285317, NULL, 6734647961714757, '2023-05-24 16:31:14.849716');
COMMIT;

-- ----------------------------
-- Table structure for edu_school_student
-- ----------------------------
DROP TABLE IF EXISTS "public"."edu_school_student";
CREATE TABLE "public"."edu_school_student" (
  "id" int8 NOT NULL,
...
;
ALTER TABLE "public"."edu_school_student" OWNER TO "kuaimk";
COMMENT ON COLUMN "public"."edu_school_student"."id" IS 'ID，保持与USERID一致';
COMMENT ON COLUMN "public"."edu_school_student"."no" IS '学号';
COMMENT ON COLUMN "public"."edu_school_student"."avatar" IS '头像';
COMMENT ON COLUMN "public"."edu_school_student"."name" IS '姓名';
COMMENT ON COLUMN "public"."edu_school_student"."mobile" IS '手机号';
COMMENT ON COLUMN "public"."edu_school_student"."union_main_id" IS '所属主体';
COMMENT ON COLUMN "public"."edu_school_student"."state" IS '状态： -1毕业，0待确认，1在读，2休学，3退学';
COMMENT ON COLUMN "public"."edu_school_student"."last_active_ip" IS '最后活跃IP';
COMMENT ON COLUMN "public"."edu_school_student"."hired_at" IS '入学时间';
COMMENT ON COLUMN "public"."edu_school_student"."sex" IS '性别：0女 1男';

-- ----------------------------
-- Records of edu_school_student
-- ----------------------------
BEGIN;
INSERT INTO "public"."edu_school_student" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6730105419530309, '001', '', '测试0523', '18183426320', 6730105417498693, 1, NULL, '2023-05-23 16:14:20.936424', 5302581852373061, '2023-05-23 16:14:21.269173', NULL, '2023-05-23 16:14:21.269173', NULL, NULL, 0);
INSERT INTO "public"."edu_school_student" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6730154277208133, '001', '', '学校管理员0523', '18183426417', 6730154276552773, 1, NULL, '2023-05-23 16:26:46.464823', 6730105419530309, '2023-05-23 16:26:46.827266', NULL, '2023-05-23 16:26:46.827266', NULL, NULL, 0);
INSERT INTO "public"."edu_school_student" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6730158708752453, '001', '', '学校02管理员0523', '18183197534', 6730158708162629, 1, NULL, '2023-05-23 16:27:54.086425', 6730105419530309, '2023-05-23 16:27:54.335175', NULL, '2023-05-23 16:27:54.335175', NULL, NULL, 0);
INSERT INTO "public"."edu_school_student" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6730278827655237, '0523-1-1', '', '01学校教师01', '13404261867', 6730154276552773, 0, NULL, NULL, 6730154277208133, '2023-05-23 16:58:27.207856', NULL, '2023-05-23 18:31:42.817579', NULL, NULL, 0);
INSERT INTO "public"."edu_school_student" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6730284475547717, '0523-1-2', '', '01学校教师02', '13404261867', 6730154276552773, -1, NULL, NULL, 6730154277208133, '2023-05-23 16:59:53.405117', 6730154277208133, '2023-05-23 18:32:47.572443', NULL, NULL, 0);
INSERT INTO "public"."edu_school_student" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6730662334496837, '0523-1-01', '', '01学校学生01', '18152534455', 6730154276552773, 1, NULL, NULL, 6730154277208133, '2023-05-23 18:35:59.055148', NULL, '2023-05-23 18:35:59.055148', NULL, NULL, 0);
INSERT INTO "public"."edu_school_student" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6730665474261061, '0523-1-02', '', '01学校学生02', '17722534455', 6730154276552773, 1, NULL, NULL, 6730154277208133, '2023-05-23 18:36:46.975284', NULL, '2023-05-23 18:36:46.975284', NULL, NULL, 0);
INSERT INTO "public"."edu_school_student" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6730667462033477, '0523-1-03', '', '01学校学生03', '19372534735', 6730154276552773, 0, NULL, NULL, 6730154277208133, '2023-05-23 18:37:17.357237', NULL, '2023-05-23 18:37:17.357237', NULL, NULL, 1);
INSERT INTO "public"."edu_school_student" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6734235908505669, '0524-2-01', '', '02学校学生01', '18121833427', 6730158708162629, 2, NULL, NULL, 6730158708752453, '2023-05-24 09:44:47.491403', NULL, '2023-05-24 09:44:47.491403', NULL, NULL, 1);
INSERT INTO "public"."edu_school_student" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6734242085208133, '0524-2-1', '', '02学校教师01', '13471461591', 6730158708162629, -1, NULL, NULL, 6730158708752453, '2023-05-24 09:46:21.719263', NULL, '2023-05-24 09:46:21.719263', NULL, NULL, 0);
INSERT INTO "public"."edu_school_student" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6734261496774725, '0524-2-2', '', '02学校教师02', '15631419438', 6730158708162629, 1, NULL, NULL, 6730158708752453, '2023-05-24 09:51:17.91301', NULL, '2023-05-24 09:51:17.91301', NULL, NULL, 1);
INSERT INTO "public"."edu_school_student" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6734675772047429, '0524-1-01', '', '0524学校01学生01', '18127948151', 6734647961714757, 1, NULL, NULL, 6734647962435653, '2023-05-24 11:36:39.270293', NULL, '2023-05-24 11:36:39.270293', NULL, NULL, 1);
INSERT INTO "public"."edu_school_student" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6734694846890053, '0524-1-03', '', '0524学校01学生03', '19348761000', 6734647961714757, -2, NULL, NULL, 6734647962435653, '2023-05-24 11:41:30.322397', NULL, '2023-05-24 11:42:01.842547', NULL, '2023-05-24 11:42:01.847856', 1);
INSERT INTO "public"."edu_school_student" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6734693023285317, '0524-1-02', '', '0524学校01学生02', '19348761851', 6734647961714757, 2, NULL, NULL, 6734647962435653, '2023-05-24 11:41:02.498517', 6734647962435653, '2023-05-24 14:32:10.830061', NULL, NULL, 2);
COMMIT;

-- ----------------------------
-- Table structure for edu_school_teacher
-- ----------------------------
DROP TABLE IF EXISTS "public"."edu_school_teacher";
CREATE TABLE "public"."edu_school_teacher" (
  "id" int8 NOT NULL,
  "no" varchar(16) COLLATE "pg_catalog"."default",
  "avatar" text COLLATE "pg_catalog"."default",
  "name" varchar(16) COLLATE "pg_catalog"."default" NOT NULL,
...
;
ALTER TABLE "public"."edu_school_teacher" OWNER TO "kuaimk";
COMMENT ON COLUMN "public"."edu_school_teacher"."id" IS 'ID，保持与USERID一致';
COMMENT ON COLUMN "public"."edu_school_teacher"."no" IS '工号';
COMMENT ON COLUMN "public"."edu_school_teacher"."avatar" IS '头像';
COMMENT ON COLUMN "public"."edu_school_teacher"."name" IS '姓名';
COMMENT ON COLUMN "public"."edu_school_teacher"."mobile" IS '手机号';
COMMENT ON COLUMN "public"."edu_school_teacher"."union_main_id" IS '所属主体';
COMMENT ON COLUMN "public"."edu_school_teacher"."state" IS '状态： -1已离职，0待确认，1已入职';
COMMENT ON COLUMN "public"."edu_school_teacher"."last_active_ip" IS '最后活跃IP';
COMMENT ON COLUMN "public"."edu_school_teacher"."hired_at" IS '入职时间';
COMMENT ON COLUMN "public"."edu_school_teacher"."sex" IS '性别：0女 1男';

-- ----------------------------
-- Records of edu_school_teacher
-- ----------------------------
BEGIN;
INSERT INTO "public"."edu_school_teacher" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6734407010353221, '0524-2-3', '', '02学校教师03', '17716489473', 6730158708162629, 1, NULL, NULL, 6730158708752453, '2023-05-24 10:28:18.279147', NULL, '2023-05-24 10:28:18.279147', NULL, NULL, 1);
INSERT INTO "public"."edu_school_teacher" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6734417466294341, '001', '', '学校03管理员0524', '18183197123', 6734417465507909, 1, NULL, '2023-05-24 10:30:57.566802', 6730105419530309, '2023-05-24 10:30:57.821251', NULL, '2023-05-24 10:30:57.821251', NULL, NULL, 0);
INSERT INTO "public"."edu_school_teacher" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6734637130252357, '001', '', '协会管理员01', '19838273548', 6734637127893061, 1, NULL, '2023-05-24 11:26:49.349374', 5302581852373061, '2023-05-24 11:26:49.702853', NULL, '2023-05-24 11:26:49.702853', NULL, NULL, 0);
INSERT INTO "public"."edu_school_teacher" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6734647962435653, '001', '', '学校01管理员01', '19861312951', 6734647961714757, 1, NULL, '2023-05-24 11:29:34.660094', 6734637130252357, '2023-05-24 11:29:34.955236', NULL, '2023-05-24 11:29:34.955236', NULL, NULL, 0);
INSERT INTO "public"."edu_school_teacher" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6734661584420933, '0524-1-01', '', '0524学校01教师01', '18167981702', 6734647961714757, 1, NULL, NULL, 6734647962435653, '2023-05-24 11:33:02.770332', NULL, '2023-05-24 11:33:02.770332', NULL, NULL, 0);
INSERT INTO "public"."edu_school_teacher" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6734669398999109, '0524-1-02', '', '0524学校01教师02', '15167891235', 6734647961714757, 1, NULL, NULL, 6734647962435653, '2023-05-24 11:35:02.026234', NULL, '2023-05-24 11:35:02.026234', NULL, NULL, 1);
INSERT INTO "public"."edu_school_teacher" ("id", "no", "avatar", "name", "mobile", "union_main_id", "state", "last_active_ip", "hired_at", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at", "sex") VALUES (6734816100155461, '0524-1-03', '', '0524学校01教师03', '13345916544', 6734647961714757, -2, NULL, NULL, 6734647962435653, '2023-05-24 12:12:20.508066', 6734647962435653, '2023-05-24 12:16:56.806518', NULL, '2023-05-24 12:16:56.808331', 0);
COMMIT;
...
;
ALTER TABLE "public"."sys_area" OWNER TO "kuaimk";
...
CREATE TABLE "public"."sys_audit" (
  ...
  "audit_reply_at" timestamp(6),
  "history_Items" text COLLATE "pg_catalog"."default",
  "created_at" timestamp(6),
  "audit_user_id" int8
)
;
ALTER TABLE "public"."sys_audit" OWNER TO "kuaimk";
COMMENT ON COLUMN "public"."sys_audit"."state" IS '审核状态：-1不通过，0待审核，1通过';
COMMENT ON COLUMN "public"."sys_audit"."reply" IS '不通过时回复的审核不通过原因';
...
COMMENT ON COLUMN "public"."sys_audit"."audit_reply_at" IS '审核回复时间';
COMMENT ON COLUMN "public"."sys_audit"."history_Items" IS '历史申请记录';
COMMENT ON COLUMN "public"."sys_audit"."audit_user_id" IS '审核操作者id';
...
CREATE TABLE "public"."sys_casbin" (
  "ptype" varchar(10) COLLATE "pg_catalog"."default" NOT NULL,
...
;
ALTER TABLE "public"."sys_casbin" OWNER TO "kuaimk";

-- ----------------------------
-- Records of sys_casbin
-- ----------------------------
BEGIN;
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6730021662294085', 'Super.Admin', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6730021643419717', '6730021662294085', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6730035381469253', 'Super.Admin', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6730035362791493', '6730035381469253', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6730052159733829', 'Super.Admin', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6730052142301253', '6730052159733829', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6730105444892741', 'Super.Admin', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6730105419530309', '6730105444892741', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6730144612089925', 'Super.Admin', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6730144594526277', '6730144612089925', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6730154303160389', 'Super.Admin', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6730154277208133', '6730154303160389', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6730158726053957', 'Super.Admin', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6730158708752453', '6730158726053957', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734417484316741', 'Super.Admin', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734417466294341', '6734417484316741', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734600681750597', 'Super.Admin', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734600658812997', '6734600681750597', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734608306143301', 'Super.Admin', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734608287137861', '6734608306143301', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734622094000197', 'Super.Admin', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734622075387973', '6734622094000197', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734622560747589', 'Super.Admin', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734622544494661', '6734622560747589', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734627923492933', 'Super.Admin', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734627902980165', '6734627923492933', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734634369744965', 'Super.Admin', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734634350215237', '6734634369744965', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734637155745861', 'Super.Admin', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734637130252357', '6734637155745861', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734647983013957', 'Super.Admin', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734647962435653', '6734647983013957', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734762697097285', 'Super.Admin', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734675772047429', '6734762697097285', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734839207297093', 'Super.Admin', 'kysion.com', '', '', '');
INSERT INTO "public"."sys_casbin" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5") VALUES ('g', '6734661584420933', '6734839207297093', 'kysion.com', '', '', '');
COMMIT;
...
;
ALTER TABLE "public"."sys_config" OWNER TO "kuaimk";
...
;
ALTER TABLE "public"."sys_file" OWNER TO "kuaimk";
...
COMMENT ON COLUMN "public"."sys_file"."local_path" IS '本地路径';
...
;
ALTER TABLE "public"."sys_license" OWNER TO "kuaimk";
...
;
ALTER TABLE "public"."sys_logs" OWNER TO "kuaimk";
...
;
ALTER TABLE "public"."sys_menu" OWNER TO "kuaimk";
...
;
ALTER TABLE "public"."sys_organization" OWNER TO "kuaimk";
...
;
ALTER TABLE "public"."sys_permission" OWNER TO "kuaimk";
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5947106208184773, 0, '用户管理', '', 'User', 1, 0, 1, 0, '2023-05-20 14:18:45.089929', '2023-05-20 14:18:45.089929');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5947175853095365, 5947106208184773, '查看详情', '查看某个用户登录信息', 'User::ViewDetail', 1, 0, 1, 0, '2023-05-20 14:18:45.119436', '2023-05-20 14:18:45.119436');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5947175853095366, 5947106208184773, '查看更多详情', '含完整手机号', 'User::ViewMoreDetail', 1, 0, 1, 1, '2023-05-20 14:18:45.121755', '2023-05-20 14:18:45.121755');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5947176286288325, 5947106208184773, '用户列表', '查看所有用户', 'User::List', 1, 0, 1, 2, '2023-05-20 14:18:45.123981', '2023-05-20 14:18:45.123981');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5947177123969477, 5947106208184773, '重置密码', '重置某个用户的登录密码', 'User::ResetPassword', 1, 0, 1, 3, '2023-05-20 14:18:45.126407', '2023-05-20 14:18:45.126407');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5947176737372613, 5947106208184773, '设置状态', '设置某个用户的状态', 'User::SetState', 1, 0, 1, 4, '2023-05-20 14:18:45.131885', '2023-05-20 14:18:45.131885');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5947177469213125, 5947106208184773, '修改密码', '修改自己的登录密码', 'User::ChangePassword', 1, 0, 1, 5, '2023-05-20 14:18:45.135689', '2023-05-20 14:18:45.135689');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5949854362632262, 5947106208184773, '修改用户名称', '修改用户登录账户名称信息', 'User::Update', 1, 0, 1, 6, '2023-05-20 14:18:45.138957', '2023-05-20 14:18:45.138957');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5949854362632264, 5947106208184773, '设置用户角色', '设置某一个用户的角色', 'User::SetUserRole', 1, 0, 1, 7, '2023-05-20 14:18:45.144684', '2023-05-20 14:18:45.144684');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5949854362632265, 5947106208184773, '设置用户权限', '设置某一个用户的权限', 'User::SetPermission', 1, 0, 1, 8, '2023-05-20 14:18:45.148465', '2023-05-20 14:18:45.148465');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948649344204869, 0, '组织架构', '', 'Organization', 1, 0, 0, 1, '2023-05-20 14:18:45.152236', '2023-05-20 14:18:45.152236');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948649434447941, 5948649344204869, '查看组织架构', '查看某个组织架构', 'Organization::ViewDetail', 1, 0, 0, 0, '2023-05-20 14:18:45.155508', '2023-05-20 14:18:45.155508');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948649530392645, 5948649344204869, '组织架构列表', '查看所有组织架构列表', 'Organization::List', 1, 0, 0, 1, '2023-05-20 14:18:45.158429', '2023-05-20 14:18:45.158429');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948649642721349, 5948649344204869, '更新组织架构', '更新某个组织架构', 'Organization::Update', 1, 0, 0, 2, '2023-05-20 14:18:45.161456', '2023-05-20 14:18:45.161456');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948649739583557, 5948649344204869, '删除组织架构', '删除某个组织架构', 'Organization::Delete', 1, 0, 0, 3, '2023-05-20 14:18:45.166603', '2023-05-20 14:18:45.166603');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948649828712517, 5948649344204869, '创建组织架构', '创建组织架构', 'Organization::Create', 1, 0, 0, 4, '2023-05-20 14:18:45.171591', '2023-05-20 14:18:45.171591');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948684761759818, 0, '角色管理', '', 'Role', 1, 0, 1, 2, '2023-05-20 14:18:45.178163', '2023-05-20 14:18:45.178163');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948684761759813, 5948684761759818, '查看角色', '查看某个角色', 'Role::ViewDetail', 1, 0, 1, 0, '2023-05-20 14:18:45.182726', '2023-05-20 14:18:45.182726');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948684761759814, 5948684761759818, '角色列表', '查看所有角色', 'Role::List', 1, 0, 1, 1, '2023-05-20 14:18:45.187007', '2023-05-20 14:18:45.187007');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948684761759815, 5948684761759818, '更新角色信息', '更新某个角色信息', 'Role::Update', 1, 0, 1, 2, '2023-05-20 14:18:45.190408', '2023-05-20 14:18:45.190408');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948684761759816, 5948684761759818, '删除角色', '删除某个角色', 'Role::Delete', 1, 0, 1, 3, '2023-05-20 14:18:45.193412', '2023-05-20 14:18:45.193412');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948684761759817, 5948684761759818, '创建角色', '创建一个新角色', 'Role::Create', 1, 0, 1, 4, '2023-05-20 14:18:45.199329', '2023-05-20 14:18:45.199329');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5950451522795973, 5948684761759818, '设置角色成员', '增加或移除角色成员', 'Role::SetMember', 1, 0, 1, 5, '2023-05-20 14:18:45.20594', '2023-05-20 14:18:45.20594');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5950452043151813, 5948684761759818, '设置角色权限', '设置某个角色的权限', 'Role::SetPermission', 1, 0, 1, 6, '2023-05-20 14:18:45.209217', '2023-05-20 14:18:45.209217');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5950408166668741, 0, '权限管理', '', 'Permission', 1, 0, 1, 3, '2023-05-20 14:18:45.212602', '2023-05-20 14:18:45.212602');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948682180886598, 5950408166668741, '查看权限', '查看某个权限', 'Permission::ViewDetail', 1, 0, 1, 0, '2023-05-20 14:18:45.215458', '2023-05-20 14:18:45.215458');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948682180886599, 5950408166668741, '权限列表', '查看所有权限', 'Permission::List', 1, 0, 1, 1, '2023-05-20 14:18:45.218043', '2023-05-20 14:18:45.218043');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948682180886600, 5950408166668741, '更新权限', '更新某个权限', 'Permission::Update', 1, 0, 1, 2, '2023-05-20 14:18:45.224364', '2023-05-20 14:18:45.224364');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948682180886601, 5950408166668741, '删除权限', '删除某个权限', 'Permission::Delete', 1, 0, 1, 3, '2023-05-20 14:18:45.227859', '2023-05-20 14:18:45.227859');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948682180886602, 5950408166668741, '创建权限', '创建权限', 'Permission::Create', 1, 0, 1, 4, '2023-05-20 14:18:45.230987', '2023-05-20 14:18:45.230987');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5950408166676321, 0, '菜单管理', '', 'Menu', 1, 0, 0, 4, '2023-05-20 14:18:45.233817', '2023-05-20 14:18:45.233817');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948649434487532, 5950408166676321, '查看菜单', '查看某个菜单', 'Menu::ViewDetail', 1, 0, 0, 0, '2023-05-20 14:18:45.236956', '2023-05-20 14:18:45.236956');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948649530309523, 5950408166676321, '菜单树', '查看菜单树', 'Menu::Tree', 1, 0, 0, 1, '2023-05-20 14:18:45.244587', '2023-05-20 14:18:45.244587');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948649642787342, 5950408166676321, '更新菜单', '更新某个菜单', 'Menu::Update', 1, 0, 0, 2, '2023-05-20 14:18:45.249691', '2023-05-20 14:18:45.249691');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948649739509856, 5950408166676321, '删除菜单', '删除某个菜单', 'Menu::Delete', 1, 0, 0, 3, '2023-05-20 14:18:45.253679', '2023-05-20 14:18:45.253679');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5948649828767321, 5950408166676321, '创建菜单', '创建菜单', 'Menu::Create', 1, 0, 0, 4, '2023-05-20 14:18:45.257241', '2023-05-20 14:18:45.257241');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953153121845333, 0, '资质', '', 'License', 1, 0, 1, 5, '2023-05-20 14:18:45.263471', '2023-05-20 14:18:45.263471');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953153121845328, 5953153121845333, '查看主体信息', '查看某条主体信息', 'License::ViewDetail', 1, 0, 1, 0, '2023-05-20 14:18:45.26668', '2023-05-20 14:18:45.26668');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953153121845329, 5953153121845333, '主体列表', '查看所有主体信息', 'License::List', 1, 0, 1, 1, '2023-05-20 14:18:45.271527', '2023-05-20 14:18:45.271527');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953153121845330, 5953153121845333, '更新资质审核信息', '更新某条资质审核信息', 'License::Update', 1, 0, 1, 2, '2023-05-20 14:18:45.29944', '2023-05-20 14:18:45.29944');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953153121845332, 5953153121845333, '创建主体', '创建主体信息', 'License::Create', 1, 0, 1, 3, '2023-05-20 14:18:45.304819', '2023-05-20 14:18:45.304819');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953153121845331, 5953153121845333, '设置主体状态', '设置某主体认证状态', 'License::SetState', 1, 0, 1, 4, '2023-05-20 14:18:45.308403', '2023-05-20 14:18:45.308403');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953151699124300, 0, '审核管理', '', 'Audit', 1, 0, 1, 6, '2023-05-20 14:18:45.315769', '2023-05-20 14:18:45.315769');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953151699124297, 5953151699124300, '查看资质审核信息', '查看某条资质审核信息', 'Audit::ViewDetail', 1, 0, 1, 0, '2023-05-20 14:18:45.320609', '2023-05-20 14:18:45.320609');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953151699124298, 5953151699124300, '资质审核列表', '查看所有资质审核', 'Audit::List', 1, 0, 1, 1, '2023-05-20 14:18:45.323594', '2023-05-20 14:18:45.323594');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953151699124299, 5953151699124300, '更新资质审核信息', '更新某条资质审核信息', 'Audit::Update', 1, 0, 1, 2, '2023-05-20 14:18:45.326306', '2023-05-20 14:18:45.326306');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5947986066667901, 0, 'Oss存储', '', 'oss', 1, 0, 1, 0, '2023-05-20 14:18:45.328813', '2023-05-20 14:18:45.328813');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5947986066667973, 0, 'Sms短信', '', 'sms', 1, 0, 1, 0, '2023-05-20 14:18:45.331137', '2023-05-20 14:18:45.331137');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6712663933648965, 5947986066667973, '发送短信', '', 'sms::SendSms', 1, 1, 1, 0, '2023-05-20 14:18:45.33326', '2023-05-20 14:18:45.33326');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6712663933648981, 5947986066667973, '发送验证码短信', '', 'sms::SendCaptchaBySms', 1, 1, 1, 1, '2023-05-20 14:18:45.339357', '2023-05-20 14:18:45.339357');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6712663933648997, 5947986066667973, '接收短信', '', 'sms::ReceiveSms', 1, 1, 1, 2, '2023-05-20 14:18:45.343268', '2023-05-20 14:18:45.343268');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6712663933649013, 5947986066667973, '查看应用配置信息', '', 'sms::ViewAppConfig', 1, 1, 1, 3, '2023-05-20 14:18:45.346329', '2023-05-20 14:18:45.346329');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6712663933714506, 5947986066667973, '创建应用配置', '', 'sms::CreateAppConfig', 1, 1, 1, 4, '2023-05-20 14:18:45.349427', '2023-05-20 14:18:45.349427');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6712663933714522, 5947986066667973, '创建模板', '', 'sms::CreateTemplate', 1, 1, 1, 5, '2023-05-20 14:18:45.352848', '2023-05-20 14:18:45.352848');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6712663933714538, 5947986066667973, '审核模板', '', 'sms::AuditTemplate', 1, 1, 1, 6, '2023-05-20 14:18:45.3608', '2023-05-20 14:18:45.3608');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6712663933714554, 5947986066667973, '查看模板信息', '', 'sms::ViewTemplate', 1, 1, 1, 7, '2023-05-20 14:18:45.367988', '2023-05-20 14:18:45.367988');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6712663933780047, 5947986066667973, '创建签名', '', 'sms::CreateSign', 1, 1, 1, 8, '2023-05-20 14:18:45.371901', '2023-05-20 14:18:45.371901');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6712663933780063, 5947986066667973, '审核签名', '', 'sms::AuditSign', 1, 1, 1, 9, '2023-05-20 14:18:45.374854', '2023-05-20 14:18:45.374854');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6712663933780079, 5947986066667973, '查看签名', '', 'sms::ViewSign', 1, 1, 1, 10, '2023-05-20 14:18:45.382573', '2023-05-20 14:18:45.382573');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6712663933780095, 5947986066667973, '创建业务配置', '', 'sms::CreateProvider', 1, 1, 1, 11, '2023-05-20 14:18:45.386733', '2023-05-20 14:18:45.386733');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6712663933845588, 5947986066667973, '查看业务配置信息', '', 'sms::ViewProvider', 1, 1, 1, 12, '2023-05-20 14:18:45.39009', '2023-05-20 14:18:45.39009');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6712663933845604, 5947986066667973, '查看业务配置列表', '', 'sms::ViewProviderList', 1, 1, 1, 13, '2023-05-20 14:18:45.393603', '2023-05-20 14:18:45.393603');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6712663933845620, 5947986066667973, '查看短信发送日志', '', 'sms::ViewSendLog', 1, 1, 1, 14, '2023-05-20 14:18:45.396349', '2023-05-20 14:18:45.396349');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251022919, 0, '服务商', '', 'edu_school', 1, 0, 1, 0, '2023-05-20 17:37:27.151202', '2023-05-20 17:37:27.151202');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251219526, 6713445251022919, '新增', '', 'edu_school::Create', 1, 1, 1, 0, '2023-05-20 17:37:27.194684', '2023-05-20 17:37:27.194684');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251219535, 6713445251022919, '查看明细', '', 'edu_school::ViewDetail', 1, 1, 1, 1, '2023-05-20 17:37:27.199428', '2023-05-20 17:37:27.199428');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251219548, 6713445251022919, '列表', '', 'edu_school::List', 1, 1, 1, 2, '2023-05-20 17:37:27.203215', '2023-05-20 17:37:27.203215');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251219557, 6713445251022919, '更新', '', 'edu_school::Update', 1, 1, 1, 3, '2023-05-20 17:37:27.206877', '2023-05-20 17:37:27.206877');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251219569, 6713445251022919, '设置LOGO', '', 'edu_school::SetLogo', 1, 1, 1, 4, '2023-05-20 17:37:27.210403', '2023-05-20 17:37:27.210403');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251219580, 6713445251022919, '设置状态', '', 'edu_school::SetState', 1, 1, 1, 5, '2023-05-20 17:37:27.213932', '2023-05-20 17:37:27.213932');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251285068, 6713445251022919, '设置管理员', '', 'edu_school::SetAdminUser', 1, 1, 1, 6, '2023-05-20 17:37:27.217646', '2023-05-20 17:37:27.217646');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251285079, 6713445251022919, '查看认证信息', '查看公司认证信息', 'edu_school::ViewLicense', 1, 1, 1, 7, '2023-05-20 17:37:27.221307', '2023-05-20 17:37:27.221307');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251285090, 6713445251022919, '审核认证信息', '审核公司认证信息', 'edu_school::AuditLicense', 1, 1, 1, 8, '2023-05-20 17:37:27.224716', '2023-05-20 17:37:27.224716');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251285092, 0, '服务商员工', '', 'edu_school_teacher', 1, 0, 1, 1, '2023-05-20 17:37:27.228314', '2023-05-20 17:37:27.228314');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251285093, 6713445251285092, '详情', '查看员工详情', 'edu_school_teacher::ViewDetail', 1, 1, 1, 0, '2023-05-20 17:37:27.23352', '2023-05-20 17:37:27.23352');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251285107, 6713445251285092, '更多详情', '查看员工更多详情含手机号等', 'edu_school_teacher::MoreDetail', 1, 1, 1, 1, '2023-05-20 17:37:27.237016', '2023-05-20 17:37:27.237016');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251350598, 6713445251285092, '列表', '查看员工列表', 'edu_school_teacher::List', 1, 1, 1, 2, '2023-05-20 17:37:27.240347', '2023-05-20 17:37:27.240347');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251350612, 6713445251285092, '新增', '新增员工信息', 'edu_school_teacher::Create', 1, 1, 1, 3, '2023-05-20 17:37:27.243586', '2023-05-20 17:37:27.243586');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251350626, 6713445251285092, '更新', '更新员工信息', 'edu_school_teacher::Update', 1, 1, 1, 4, '2023-05-20 17:37:27.246649', '2023-05-20 17:37:27.246649');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251350640, 6713445251285092, '删除', '删除员工信息', 'edu_school_teacher::Delete', 1, 1, 1, 5, '2023-05-20 17:37:27.249661', '2023-05-20 17:37:27.249661');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251350654, 6713445251285092, '设置手机号', '修改员工手机号', 'edu_school_teacher::SetMobile', 1, 1, 1, 6, '2023-05-20 17:37:27.252689', '2023-05-20 17:37:27.252689');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251416145, 6713445251285092, '设置头像', '设置员工头像', 'edu_school_teacher::SetAvatar', 1, 1, 1, 7, '2023-05-20 17:37:27.255873', '2023-05-20 17:37:27.255873');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251416160, 6713445251285092, '设置状态', '设置员工任职状态', 'edu_school_teacher::SetState', 1, 1, 1, 8, '2023-05-20 17:37:27.258969', '2023-05-20 17:37:27.258969');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251416174, 6713445251285092, '查看认证信息', '查看员工认证信息', 'edu_school_teacher::ViewLicense', 1, 1, 1, 9, '2023-05-20 17:37:27.262224', '2023-05-20 17:37:27.262224');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251416188, 6713445251285092, '审核认证信息', '审核员工认证信息', 'edu_school_teacher::AuditLicense', 1, 1, 1, 10, '2023-05-20 17:37:27.265522', '2023-05-20 17:37:27.265522');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251481679, 6713445251285092, '更新认证信息', '更新员工认证信息', 'edu_school_teacher::UpdateLicense', 1, 1, 1, 11, '2023-05-20 17:37:27.268611', '2023-05-20 17:37:27.268611');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251481680, 0, '服务商班级', '', 'edu_school_class', 1, 0, 1, 2, '2023-05-20 17:37:27.271749', '2023-05-20 17:37:27.271749');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251481683, 6713445251481680, '新增', '新增团队信息', 'edu_school_class::Create', 1, 1, 1, 0, '2023-05-20 17:37:27.274827', '2023-05-20 17:37:27.274827');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251481690, 6713445251481680, '详情', '查看团队详情', 'edu_school_class::ViewDetail', 1, 1, 1, 1, '2023-05-20 17:37:27.277943', '2023-05-20 17:37:27.277943');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251481700, 6713445251481680, '列表', '查看团队列表', 'edu_school_class::List', 1, 1, 1, 2, '2023-05-20 17:37:27.281139', '2023-05-20 17:37:27.281139');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251481711, 6713445251481680, '更新', '更新团队信息', 'edu_school_class::Update', 1, 1, 1, 3, '2023-05-20 17:37:27.284157', '2023-05-20 17:37:27.284157');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251481721, 6713445251481680, '删除', '删除团队信息', 'edu_school_class::Delete', 1, 1, 1, 4, '2023-05-20 17:37:27.287293', '2023-05-20 17:37:27.287293');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251547208, 6713445251481680, '成员详情', '查看团队成员详情', 'edu_school_class::MemberDetail', 1, 1, 1, 5, '2023-05-20 17:37:27.290901', '2023-05-20 17:37:27.290901');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251547218, 6713445251481680, '设置成员', '设置团队成员', 'edu_school_class::SetMember', 1, 1, 1, 6, '2023-05-20 17:37:27.294027', '2023-05-20 17:37:27.294027');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251547228, 6713445251481680, '设置管理人', '设置团队管理人，可以不是团队成员', 'edu_school_class::SetOwner', 1, 1, 1, 7, '2023-05-20 17:37:27.297004', '2023-05-20 17:37:27.297004');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251547238, 6713445251481680, '设置队长或组长', '设置团队队长或小组组长，必须是团队成员', 'edu_school_class::SetCaptain', 1, 1, 1, 8, '2023-05-20 17:37:27.300087', '2023-05-20 17:37:27.300087');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251547239, 0, '财务', '', 'Financial', 1, 0, 1, 0, '2023-05-20 17:37:27.303164', '2023-05-20 17:37:27.303164');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251547240, 6713445251547239, '发票', '', 'Financial::Invoice', 1, 0, 1, 0, '2023-05-20 17:37:27.306276', '2023-05-20 17:37:27.306276');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953153121845334, 6713445251547240, '查看发票详情', '查看发票详情信息', 'Financial::Invoice::ViewDetail', 1, 0, 1, 0, '2023-05-20 17:37:27.310716', '2023-05-20 17:37:27.310716');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953153121845335, 6713445251547240, '查看发票抬头信息', '查看发票抬头信息', 'Financial::Invoice::ViewInvoice', 1, 0, 1, 1, '2023-05-20 17:37:27.313835', '2023-05-20 17:37:27.313835');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953153121845338, 6713445251547240, '发票抬头列表', '查看所有发票抬头', 'Financial::Invoice::InvoiceList', 1, 0, 1, 2, '2023-05-20 17:37:27.318002', '2023-05-20 17:37:27.318002');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953153121845339, 6713445251547240, '发票详情列表', '查看所有发票详情', 'Financial::Invoice::InvoiceDetailList', 1, 0, 1, 3, '2023-05-20 17:37:27.32168', '2023-05-20 17:37:27.32168');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953153121845340, 6713445251547240, '审核发票', '审核发票申请', 'Financial::Invoice::AuditInvoiceDetail', 1, 0, 1, 4, '2023-05-20 17:37:27.326173', '2023-05-20 17:37:27.326173');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953153121845341, 6713445251547240, '开发票', '添加发票详情记录', 'Financial::Invoice::MakeInvoiceDetail', 1, 0, 1, 5, '2023-05-20 17:37:27.330778', '2023-05-20 17:37:27.330778');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953153121845342, 6713445251547240, '添加发票抬头', '添加发票抬头信息', 'Financial::Invoice::CreateInvoice', 1, 0, 1, 6, '2023-05-20 17:37:27.334441', '2023-05-20 17:37:27.334441');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953153121845344, 6713445251547240, '删除发票抬头', '删除发票抬头信息', 'Financial::Invoice::DeleteInvoice', 1, 0, 1, 7, '2023-05-20 17:37:27.338805', '2023-05-20 17:37:27.338805');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251547241, 6713445251547239, '银行卡', '', 'Financial::BankCard', 1, 0, 1, 1, '2023-05-20 17:37:27.343273', '2023-05-20 17:37:27.343273');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953153121845336, 6713445251547241, '查看银行卡', '查看银行卡信息', 'Financial::BankCard::ViewBankCardDetail', 1, 0, 1, 0, '2023-05-20 17:37:27.348106', '2023-05-20 17:37:27.348106');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953153121845337, 6713445251547241, '银行卡列表', '查看所有银行卡', 'Financial::BankCard::BankCardList', 1, 0, 1, 1, '2023-05-20 17:37:27.35158', '2023-05-20 17:37:27.35158');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953153121845343, 6713445251547241, '添加银行卡', '添加银行卡信息', 'Financial::BankCard::CreateBankCard', 1, 0, 1, 2, '2023-05-20 17:37:27.35511', '2023-05-20 17:37:27.35511');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953153121845345, 6713445251547241, '删除银行卡', '删除银行卡信息', 'Financial::BankCard::DeleteBankCard', 1, 0, 1, 3, '2023-05-20 17:37:27.358453', '2023-05-20 17:37:27.358453');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713445251547242, 6713445251547239, '财务账号', '', 'Financial::Account', 1, 0, 1, 2, '2023-05-20 17:37:27.363389', '2023-05-20 17:37:27.363389');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953153121845346, 6713445251547242, '查看余额', '查看账号余额', 'Financial::Account::GetAccountBalance', 1, 0, 1, 0, '2023-05-20 17:37:27.367828', '2023-05-20 17:37:27.367828');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (5953153121849347, 6713445251547242, '查看财务账号详情', '查看财务账号金额明细', 'Financial::Account::GetAccountDetail', 1, 0, 1, 1, '2023-05-20 17:37:27.371249', '2023-05-20 17:37:27.371249');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713486140571766, 0, '服务商员工', '', 'edu_school_student', 1, 0, 1, 7, '2023-05-20 17:47:51.109491', '2023-05-20 17:47:51.109491');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713486140571767, 6713486140571766, '详情', '查看员工详情', 'edu_school_student::ViewDetail', 1, 1, 1, 0, '2023-05-20 17:47:51.156212', '2023-05-20 17:47:51.156212');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713486140637258, 6713486140571766, '更多详情', '查看员工更多详情含手机号等', 'edu_school_student::MoreDetail', 1, 1, 1, 1, '2023-05-20 17:47:51.162951', '2023-05-20 17:47:51.162951');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713486140637272, 6713486140571766, '列表', '查看员工列表', 'edu_school_student::List', 1, 1, 1, 2, '2023-05-20 17:47:51.166644', '2023-05-20 17:47:51.166644');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713486140637286, 6713486140571766, '新增', '新增员工信息', 'edu_school_student::Create', 1, 1, 1, 3, '2023-05-20 17:47:51.1698', '2023-05-20 17:47:51.1698');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713486140637300, 6713486140571766, '更新', '更新员工信息', 'edu_school_student::Update', 1, 1, 1, 4, '2023-05-20 17:47:51.172616', '2023-05-20 17:47:51.172616');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713486140702791, 6713486140571766, '删除', '删除员工信息', 'edu_school_student::Delete', 1, 1, 1, 5, '2023-05-20 17:47:51.175541', '2023-05-20 17:47:51.175541');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713486140702805, 6713486140571766, '设置手机号', '修改员工手机号', 'edu_school_student::SetMobile', 1, 1, 1, 6, '2023-05-20 17:47:51.178694', '2023-05-20 17:47:51.178694');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713486140702819, 6713486140571766, '设置头像', '设置员工头像', 'edu_school_student::SetAvatar', 1, 1, 1, 7, '2023-05-20 17:47:51.181449', '2023-05-20 17:47:51.181449');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713486140702834, 6713486140571766, '设置状态', '设置员工任职状态', 'edu_school_student::SetState', 1, 1, 1, 8, '2023-05-20 17:47:51.187787', '2023-05-20 17:47:51.187787');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713486140768325, 6713486140571766, '查看认证信息', '查看员工认证信息', 'edu_school_student::ViewLicense', 1, 1, 1, 9, '2023-05-20 17:47:51.193327', '2023-05-20 17:47:51.193327');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713486140768339, 6713486140571766, '审核认证信息', '审核员工认证信息', 'edu_school_student::AuditLicense', 1, 1, 1, 10, '2023-05-20 17:47:51.197193', '2023-05-20 17:47:51.197193');
INSERT INTO "public"."sys_permission" ("id", "parent_id", "name", "description", "identifier", "type", "match_mode", "is_show", "sort", "created_at", "updated_at") VALUES (6713486140768353, 6713486140571766, '更新认证信息', '更新员工认证信息', 'edu_school_student::UpdateLicense', 1, 1, 1, 11, '2023-05-20 17:47:51.200417', '2023-05-20 17:47:51.200417');
COMMIT;
...
;
ALTER TABLE "public"."sys_role" OWNER TO "kuaimk";
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."sys_role" ("id", "name", "description", "is_system", "updated_at", "created_at", "union_main_id") VALUES (6730105444892741, '管理员', '', 't', '2023-05-23 16:14:21.380685', '2023-05-23 16:14:21.380685', 6730105417498693);
INSERT INTO "public"."sys_role" ("id", "name", "description", "is_system", "updated_at", "created_at", "union_main_id") VALUES (6730154303160389, '管理员', '', 't', '2023-05-23 16:26:46.874887', '2023-05-23 16:26:46.874887', 6730154276552773);
INSERT INTO "public"."sys_role" ("id", "name", "description", "is_system", "updated_at", "created_at", "union_main_id") VALUES (6730158726053957, '管理员', '', 't', '2023-05-23 16:27:54.361872', '2023-05-23 16:27:54.361872', 6730158708162629);
INSERT INTO "public"."sys_role" ("id", "name", "description", "is_system", "updated_at", "created_at", "union_main_id") VALUES (6734417484316741, '管理员', '', 't', '2023-05-24 10:30:57.881822', '2023-05-24 10:30:57.881822', 6734417465507909);
INSERT INTO "public"."sys_role" ("id", "name", "description", "is_system", "updated_at", "created_at", "union_main_id") VALUES (6734637155745861, '管理员', '', 't', '2023-05-24 11:26:49.803183', '2023-05-24 11:26:49.803183', 6734637127893061);
INSERT INTO "public"."sys_role" ("id", "name", "description", "is_system", "updated_at", "created_at", "union_main_id") VALUES (6734647983013957, '管理员', '', 't', '2023-05-24 11:29:34.986737', '2023-05-24 11:29:34.986737', 6734647961714757);
INSERT INTO "public"."sys_role" ("id", "name", "description", "is_system", "updated_at", "created_at", "union_main_id") VALUES (6734762697097285, '0524学校01学生角色01', '写个备注', 'f', '2023-05-24 11:58:45.39428', '2023-05-24 11:58:45.39428', 6734647961714757);
INSERT INTO "public"."sys_role" ("id", "name", "description", "is_system", "updated_at", "created_at", "union_main_id") VALUES (6734839207297093, '0524学校01教师角色01', '写个备注', 'f', '2023-05-24 12:18:12.844501', '2023-05-24 12:18:12.844501', 6734647961714757);
COMMIT;
...
;
ALTER TABLE "public"."sys_settings" OWNER TO "kuaimk";
COMMENT ON COLUMN "public"."sys_settings"."name" IS '配置名称';
COMMENT ON COLUMN "public"."sys_settings"."values" IS '配置信息JSON格式';
COMMENT ON COLUMN "public"."sys_settings"."desc" IS '描述';
COMMENT ON COLUMN "public"."sys_settings"."union_main_id" IS '关联的主体id，为0代表是平台配置';
...
;
ALTER TABLE "public"."sys_sms_logs" OWNER TO "kuaimk";
...
;
ALTER TABLE "public"."sys_user" OWNER TO "kuaimk";
...
COMMENT ON COLUMN "public"."sys_user"."type" IS '用户类型，-1超级管理员，0匿名，1学生，2教师，4家长，8广告主，16运营商，32公益机构，64平台';
...
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6730105419530309, '1u9mfqwm62t', '554a38f45d6827d37a8e8cacd89a0f7e84dea964636cba8e3ec5eb924b8fe7aa', 1, 2, '18183426320', '2023-05-23 16:14:21.24169', '2023-05-23 16:14:21.24169', NULL);
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6730154277208133, '1u9n26x7rk5', '17252820ba0d76c8361c81a4dec58899d359e9f3e647e89c6c7519e7c0eb8643', 1, 2, '18183426417', '2023-05-23 16:26:46.814635', '2023-05-23 16:26:46.814635', NULL);
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6730158708752453, '1u9n487n51h', '0c2276fdbb28ae68eabfe23c598d49ae19fd11396929c6f0d58247ba8e51acbf', 1, 2, '18183197534', '2023-05-23 16:27:54.331307', '2023-05-23 16:27:54.331307', NULL);
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6730278827655237, '1u9onerc3lx', 'a3550b955e216f5cdaec080cb78be899b6a11fcd7322c33ace2e26a3e7c1c1bc', 1, 2, '13404261867', '2023-05-23 16:58:27.202523', '2023-05-23 16:58:27.202523', NULL);
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6730284475547717, '1u9oq05y1c5', '74b11e06d5a2c0d02b6848d9228fa872ddc9ef6275496549baab3a75a59ece51', 1, 2, '13404261867', '2023-05-23 16:59:53.400379', '2023-05-23 16:59:53.400379', NULL);
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6730662334496837, '1u9tjl9eog5', 'ce174cd252fb426bb56f3437a010693786c9b9a59faf630ca2402664bccb9319', 1, 2, '18152534455', '2023-05-23 18:35:59.051741', '2023-05-23 18:35:59.051741', NULL);
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6730665474261061, '1u9tl16qq11', 'edfd47daa2ab215b667296d7b9007442ac2d664601a38f3c23656a5e443ca2d9', 1, 2, '17722534455', '2023-05-23 18:36:46.970398', '2023-05-23 18:36:46.970398', NULL);
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6730667462033477, '1u9tly27l1h', '7c8816a38bdde69fc1ecd2275d5c53c29cbcff906a2eff1ce3a958a5017f3c01', 1, 2, '19372534735', '2023-05-23 18:37:17.35087', '2023-05-23 18:37:17.35087', NULL);
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6734235908505669, '1ub359n3sxx', 'e641fb610d02cca6656c85057add51cdf25ac041d143f1f975bf15f67ad9d16b', 1, 2, '18121833427', '2023-05-24 09:44:47.485732', '2023-05-24 09:44:47.485732', NULL);
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6734242085208133, '1ub383sjz2d', 'bc6e03f292a34cd713d1b1c6d6af4387350fa33718a9678efe69834058ffe828', 1, 2, '13471461591', '2023-05-24 09:46:21.715042', '2023-05-24 09:46:21.715042', NULL);
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6734261496774725, '1ub3h0tp7ph', '3a30a86483f3f60d05b00507966eabc09fd7d0b937be8541615c9e52244f764a', 1, 2, '15631419438', '2023-05-24 09:51:17.90898', '2023-05-24 09:51:17.90898', NULL);
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6734407010353221, '1ub5bvcq7gl', '6c504bd1b02e6e690abf549b55f5fc38e6d618b3bdc3151b07f455d470e0eef2', 1, 2, '17716489473', '2023-05-24 10:28:18.251626', '2023-05-24 10:28:18.251626', NULL);
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6734417466294341, '1ub5go9xb9h', '321c24fe8a565087efb20486695b024d7d1f40bfd0e8fd11a20855cfd3587d4a', 1, 2, '18183197123', '2023-05-24 10:30:57.816593', '2023-05-24 10:30:57.816593', NULL);
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6734637130252357, '1ub89l46a11', '350b52dea7a1c68a918f94f2332e52bc55a585c65cce4f0d51b11768e75197b1', 1, 64, '19838273548', '2023-05-24 11:26:49.674314', '2023-05-24 11:26:49.674314', NULL);
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6734647962435653, '1ub8ek9dk5h', '5a1ed1b25523f4b2a54559a31b543f4cb7e9c0c6472536ee2f6c90680f0a5669', 1, 64, '19861312951', '2023-05-24 11:29:34.952665', '2023-05-24 11:29:34.952665', NULL);
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6734661584420933, '1ub8ktjjz9h', '6a83a7837e602aea21320811b88461ac3dcff488d713a1da2c562565fbf7e690', 1, 2, '18167981702', '2023-05-24 11:33:02.76455', '2023-05-24 11:33:02.76455', NULL);
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6734669398999109, '1ub8oes5idh', '6d19e634d17708a3cf922ade5cb9660405565e148de0dce5358f105ce9f99e94', 1, 2, '15167891235', '2023-05-24 11:35:02.022725', '2023-05-24 11:35:02.022725', NULL);
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6734675772047429, '1ub8rc6i1xh', '66115994d049e9e570898a1d4708682731d9266cd8130f1982f07c9fb031f6d1', 1, 1, '18127948151', '2023-05-24 11:36:39.265434', '2023-05-24 11:36:39.265434', NULL);
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6734693023285317, '1ub8z9hfy9x', 'ec4a5affaebf764b4e70939f46a9467bda57146db03feb307f26028deefcfa0c', 1, 1, '19348761851', '2023-05-24 11:41:02.495281', '2023-05-24 11:41:02.495281', NULL);
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6734694846890053, '1ub903n64p1', '15b374b05cc808061c58cde7dbc67d65c45467c1400ce17c51d3707234ddda7d', -3, 1, '19348761000', '2023-05-24 11:41:30.31824', '2023-05-24 11:42:01.836847', NULL);
INSERT INTO "public"."sys_user" ("id", "username", "password", "state", "type", "mobile", "created_at", "updated_at", "deleted_at") VALUES (6734816100155461, '1ubajsy8f2d', 'a225afaa2039c1bb09a8f7c2f2ec9d5a71f3570ec29293d3127cf71af51059c2', -3, 2, '13345916544', '2023-05-24 12:12:20.504398', '2023-05-24 12:16:56.803627', NULL);
COMMIT;
...
CREATE TABLE "public"."sys_user_detail" (
  ...
  "last_login_area" varchar(64) COLLATE "pg_catalog"."default",
  "last_login_at" timestamp(6)
)
;
ALTER TABLE "public"."sys_user_detail" OWNER TO "kuaimk";
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."sys_user_detail" ("id", "realname", "union_main_name", "last_login_ip", "last_login_area", "last_login_at") VALUES (6730105419530309, '测试0523', '0523协会创建更新', '127.0.0.1', '0|0|0|内网IP|内网IP', '2023-05-23 16:26:16.058284');
INSERT INTO "public"."sys_user_detail" ("id", "realname", "union_main_name", "last_login_ip", "last_login_area", "last_login_at") VALUES (6730158708752453, '学校02管理员0523', '0523学校创建02', '127.0.0.1', '0|0|0|内网IP|内网IP', '2023-05-23 16:35:19.695951');
INSERT INTO "public"."sys_user_detail" ("id", "realname", "union_main_name", "last_login_ip", "last_login_area", "last_login_at") VALUES (6730154277208133, '学校管理员0523', '0523学校创建01更新', '127.0.0.1', '0|0|0|内网IP|内网IP', '2023-05-23 16:44:43.344548');
INSERT INTO "public"."sys_user_detail" ("id", "realname", "union_main_name", "last_login_ip", "last_login_area", "last_login_at") VALUES (5302581852373061, '', '', '127.0.0.1', '0|0|0|内网IP|内网IP', '2023-05-24 11:15:58.63857');
INSERT INTO "public"."sys_user_detail" ("id", "realname", "union_main_name", "last_login_ip", "last_login_area", "last_login_at") VALUES (6734637130252357, '协会管理员01', '0524协会01', '127.0.0.1', '0|0|0|内网IP|内网IP', '2023-05-24 11:28:33.780847');
INSERT INTO "public"."sys_user_detail" ("id", "realname", "union_main_name", "last_login_ip", "last_login_area", "last_login_at") VALUES (6734647962435653, '学校01管理员01', '0524学校01', '127.0.0.1', '0|0|0|内网IP|内网IP', '2023-05-24 11:31:11.601334');
COMMIT;
...
-- ----------------------------
-- Indexes structure for table edu_fd_account
-- ----------------------------
CREATE INDEX "fd_account_currency_code_idx" ON "public"."edu_fd_account" USING btree (
  "currency_code" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "fd_account_id_idx" ON "public"."edu_fd_account" USING btree (
  "id" "pg_catalog"."int8_ops" ASC NULLS LAST
);
CREATE INDEX "fd_account_name_idx" ON "public"."edu_fd_account" USING btree (
  "name" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);

-- ----------------------------
-- Primary Key structure for table edu_fd_account
-- ----------------------------
ALTER TABLE "public"."edu_fd_account" ADD CONSTRAINT "fd_account_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table edu_fd_account_bill
-- ----------------------------
CREATE INDEX "fd_account_bill_fd_account_id_idx" ON "public"."edu_fd_account_bill" USING btree (
  "fd_account_id" "pg_catalog"."int8_ops" ASC NULLS LAST
);
CREATE INDEX "fd_account_bill_from_user_id_idx" ON "public"."edu_fd_account_bill" USING btree (
  "from_user_id" "pg_catalog"."int8_ops" ASC NULLS LAST
);
CREATE UNIQUE INDEX "fd_account_bill_id_idx" ON "public"."edu_fd_account_bill" USING btree (
  "id" "pg_catalog"."int8_ops" ASC NULLS LAST
);
CREATE INDEX "fd_account_bill_in_out_type_idx" ON "public"."edu_fd_account_bill" USING btree (
  "in_out_type" "pg_catalog"."int4_ops" ASC NULLS LAST
);
CREATE INDEX "fd_account_bill_to_user_id_idx" ON "public"."edu_fd_account_bill" USING btree (
  "to_user_id" "pg_catalog"."int8_ops" ASC NULLS LAST
);
CREATE INDEX "fd_account_bill_trade_at_idx" ON "public"."edu_fd_account_bill" USING btree (
  "trade_at" "pg_catalog"."timestamp_ops" ASC NULLS LAST
);
CREATE INDEX "fd_account_bill_trade_type_idx" ON "public"."edu_fd_account_bill" USING btree (
  "trade_type" "pg_catalog"."int4_ops" ASC NULLS LAST
);
CREATE INDEX "fd_account_bill_union_order_id_idx" ON "public"."edu_fd_account_bill" USING btree (
  "union_order_id" "pg_catalog"."int8_ops" ASC NULLS LAST
);

-- ----------------------------
-- Primary Key structure for table edu_fd_account_bill
-- ----------------------------
ALTER TABLE "public"."edu_fd_account_bill" ADD CONSTRAINT "fd_account_bill_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table edu_fd_account_detail
-- ----------------------------
ALTER TABLE "public"."edu_fd_account_detail" ADD CONSTRAINT "facilitator_account_detail_copy1_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table edu_fd_bank_card
-- ----------------------------
CREATE INDEX "fd_bank_card_bank_name_idx" ON "public"."edu_fd_bank_card" USING btree (
  "bank_name" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "fd_bank_card_card_number_idx" ON "public"."edu_fd_bank_card" USING btree (
  "card_number" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "fd_bank_card_holder_name_idx" ON "public"."edu_fd_bank_card" USING btree (
  "holder_name" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "fd_bank_card_id_idx" ON "public"."edu_fd_bank_card" USING btree (
  "id" "pg_catalog"."int8_ops" ASC NULLS LAST
);

-- ----------------------------
-- Uniques structure for table edu_fd_bank_card
-- ----------------------------
ALTER TABLE "public"."edu_fd_bank_card" ADD CONSTRAINT "fd_bank_card_card_number_key" UNIQUE ("card_number");

-- ----------------------------
-- Primary Key structure for table edu_fd_bank_card
-- ----------------------------
ALTER TABLE "public"."edu_fd_bank_card" ADD CONSTRAINT "fd_bank_card_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table edu_fd_currency
-- ----------------------------
CREATE INDEX "fd_currency_cn_name_idx" ON "public"."edu_fd_currency" USING btree (
  "cn_name" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "fd_currency_code_idx" ON "public"."edu_fd_currency" USING btree (
  "code" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "fd_currency_currency_code_idx" ON "public"."edu_fd_currency" USING btree (
  "currency_code" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "fd_currency_en_name_idx" ON "public"."edu_fd_currency" USING btree (
  "en_name" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);

-- ----------------------------
-- Uniques structure for table edu_fd_currency
-- ----------------------------
ALTER TABLE "public"."edu_fd_currency" ADD CONSTRAINT "fd_currency_code_key" UNIQUE ("code");
ALTER TABLE "public"."edu_fd_currency" ADD CONSTRAINT "fd_currency_currency_codc_key" UNIQUE ("currency_code");

-- ----------------------------
-- Primary Key structure for table edu_fd_currency
-- ----------------------------
ALTER TABLE "public"."edu_fd_currency" ADD CONSTRAINT "fd_currenty_pkey" PRIMARY KEY ("currency_code");

-- ----------------------------
-- Primary Key structure for table edu_fd_invoice
-- ----------------------------
ALTER TABLE "public"."edu_fd_invoice" ADD CONSTRAINT "fd_invoice_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table edu_fd_invoice_detail
-- ----------------------------
ALTER TABLE "public"."edu_fd_invoice_detail" ADD CONSTRAINT "fd_invoice_detail_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table edu_school
-- ----------------------------
ALTER TABLE "public"."edu_school" ADD CONSTRAINT "pro_company_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table edu_school_class
-- ----------------------------
ALTER TABLE "public"."edu_school_class" ADD CONSTRAINT "pro_company_team_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table edu_school_class_member
-- ----------------------------
ALTER TABLE "public"."edu_school_class_member" ADD CONSTRAINT "pro_company_team_member_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table edu_school_student
-- ----------------------------
ALTER TABLE "public"."edu_school_student" ADD CONSTRAINT "edu_school_people_copy1_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table edu_school_teacher
-- ----------------------------
ALTER TABLE "public"."edu_school_teacher" ADD CONSTRAINT "pro_company_employee_pkey" PRIMARY KEY ("id");
